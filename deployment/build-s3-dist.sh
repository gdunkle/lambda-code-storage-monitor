...
ZIP_FILE_NAME="lambda-code-storage-monitor-$timestamp.zip"
LAYER_FILE_NAME="lambda-code-storage-monitor-layer-$timestamp.zip"
cd ..
...
echo "------------------------------------------------------------------------------"
echo "[Build] lambda-code-storage-monitor Function"
echo "------------------------------------------------------------------------------"
cd $source_dir/lambda-code-storage-monitor

zip $build_dist_dir/$ZIP_FILE_NAME ./*.py


echo "------------------------------------------------------------------------------"
echo "[Build] lambda-code-storage-monitor Layer"
echo "------------------------------------------------------------------------------"
